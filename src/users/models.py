...
class Profile(models.Model):
    ...
    photo = models.ImageField(upload_to=user_directory_path, null=True, default="static/images/user.jpg")
...
class Report(models.Model):
    ...
    reporting_user = models.ForeignKey(User, related_name='reported_by', on_delete=models.CASCADE)
